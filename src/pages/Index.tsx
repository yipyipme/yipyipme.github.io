        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-4 md:grid-cols-8 gap-4">
            {quickLinks.map((link) => (
              <div
                key={link.name}
                className="flex flex-col items-center p-4 bg-white rounded-lg border border-gray-200 hover:border-orange-300 hover:shadow-md transition-all cursor-pointer group"
              >
                <div className="text-2xl mb-2">{link.icon}</div>
                <span className="text-sm font-medium text-gray-900 group-hover:text-orange-600 transition-colors text-center">
                  {link.name}
                </span>
          ...
          <div className="bg-gradient-to-r from-orange-500 to-yellow-500 rounded-xl p-8 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-orange-100 mb-4">Join 2.3K viewers watching live</p>
